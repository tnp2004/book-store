        ...
        return (
            <Layout>
                <div className="text-center h-screen">
                    <div className='p-2 group md:w-2/3 xl:w-1/3 mx-auto my-8 flex'>
                        <input className='drop-shadow-sm rounded p-1 w-full' onKeyDown={(e) => isPressEnter(e, searchBooks)} id='search' type="text" placeholder='search' onChange={(e) => SetSearchValue(e.target.value)} value={searchValue} />
                        <button onClick={searchBooks} className='drop-shadow-sm mx-2 hover:text-emerald-500'>
